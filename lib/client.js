...
function MobileImagePicker({ t }) {
    ...
    const pickImages = () => {
        ...
        input.addEventListener('change', () => {
            ...
            const staged = (0, image_intake_ts_1.stageImagesAsDrop)(files, { makeDataTransfer, makeDragEvent, makeLegacyDropEvent });
            if (staged !== null)
                document.dispatchEvent(staged.event);
        }, { once: true });
        input.click();
    };
    return ((0, jsx_runtime_1.jsx)("button", { type: "button", "data-mobile-nav": "image-picker", "aria-label": t('uploadImage'), title: t('uploadImage'), onClick: pickImages, children: (0, jsx_runtime_1.jsx)(dsh_client_ui_primitives_1.IconPaperclipOutline16, { size: 14 }) }));
}
};
